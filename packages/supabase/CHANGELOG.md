...
- **New Memory System**: Complete implementation of the new DaydreamsAI memory
  interface
- **SupabaseKVProvider**: Key-value storage with TTL support, batch operations,
  and pattern matching
- **SupabaseVectorProvider**: Vector storage using pgvector with similarity
  search and namespaces
- **SupabaseGraphProvider**: Graph storage for nodes and edges with traversal
  algorithms
...
- **Provider Architecture**: Switched from legacy BaseMemory to new
